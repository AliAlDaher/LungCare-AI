...
Original file is located at
    https://colab.research.google.com/drive/1iC_AI3RQV6_ncLGiOWJPDyySbM8hc5mZ
"""
...
# 1) LOAD DATA
FILE_PATH = 'lung_cancer_realistic_synthetic_50000.csv'
...
joblib.dump(best_reg_pipeline, 'best_survival_model.pkl')
print("Saved best survival model -> best_survival_model.pkl")
...
joblib.dump(best_clf_pipeline, 'best_stage_model.pkl')
joblib.dump(label_encoder, 'stage_label_encoder.pkl')
print('Saved best stage model -> best_stage_model.pkl')
print('Saved stage label encoder -> stage_label_encoder.pkl')

# 7) EXAMPLE: HOW TO PREDICT ON NEW DATA
print('\n' + '=' * 70)
print('EXAMPLE PREDICTION ON 1 SAMPLE')
print('=' * 70)

sample_reg_input = X_reg_test.iloc[[0]]
sample_clf_input = X_clf_test.iloc[[0]]

predicted_survival = best_reg_pipeline.predict(sample_reg_input)[0]
predicted_stage_encoded = best_clf_pipeline.predict(sample_clf_input)[0]
predicted_stage = label_encoder.inverse_transform([predicted_stage_encoded])[0]

print('Predicted survival months:', round(float(predicted_survival), 2))
